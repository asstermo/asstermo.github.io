...
|:----:
|![{{ site.url }}/img215/ManualAsstermo215Psicrometria_01.png]({{ site.url }}/img215/ManualAsstermo215Psicrometria_01.png)
...
|:----:
|<img src='{{ site.url }}/img215/ManualAsstermo215Psicrometria_02.png' />
...
|:----:
|<img src='{{ site.url }}/img215/ManualAsstermo215Psicrometria_03.png' />
...
:---: | :---: | :---:
<img src='{{ site.url }}/img215/ManualAsstermo215Psicrometria_04.png' /> | <img src='{{ site.url }}/img215/ManualAsstermo215Psicrometria_05.png' /> | <img src='{{ site.url }}/img215/ManualAsstermo215Psicrometria_06.png' />
...
|:----:
|<img src='{{ site.url }}/img215/ManualAsstermo215Psicrometria_07.png' />

Estes são os ecrãs correspondentes às 3 primeiras opções listadas:

1:HR: Com T e w | 2:HR: Com T e pv | 3:HR: Com pv e pvSat
:---: | :---: | :---:
<img src='{{ site.url }}/img215/ManualAsstermo215Psicrometria_08.png' /> | <img src='{{ site.url }}/img215/ManualAsstermo215Psicrometria_09.png' /> | <img src='{{ site.url }}/img215/ManualAsstermo215Psicrometria_10.png' />
...
|:----:
|<img src='{{ site.url }}/img215/ManualAsstermo215Psicrometria_11.png' />
...
|:----:
|<img src='{{ site.url }}/img215/ManualAsstermo215Psicrometria_12.png' />
...
|:----:
|<img src='{{ site.url }}/img215/ManualAsstermo215Psicrometria_13.png' />
...
|Este é o menu atingido por aceder à opção 6 do menu de psicrometria:
|:----:
|<img src='{{ site.url }}/img215/ManualAsstermo215Psicrometria_14.png' />
...
|:----:
|<img src='{{ site.url }}/img215/ManualAsstermo215Psicrometria_15.png' />
...
* [1:Adicionar pontos](#1:adicionar-pontos) - esta é a primeira etapa na utilização de um diagrama psicrométrico.
* [2:Alterar pontos](#2:alterar-pontos) - permite alterar os pontos adicionados.
* [3:Remover pontos](#3:remover-pontos) - permite remover os pontos adicionados.
* [4:Intersectar rectas](#4:intersectar-rectas) - permite traçar o cruzamento de duas rectas e obter o ponto de cruzamento, sendo as rectas geradas a partir de dois pontos cada.
* [5:Ver Diagrama](#5:ver-diagrama) - é para ver o diagrama no gráfico da calculadora!
* [6:Obter hs e hl](#6:obter-hs-e-hl) - permite calcular as entalpias sensível e latente a partir de dois pontos.
* [7:Inform. dos pontos](#7:inform.-dos-pontos) - permite ver toda a informação correspondente a cada ponto. A informação mostrada é: o nome do ponto, Temperatura, humidade específica, Pressão do vapor, Humidade Relativa e Entalpia.
* [8:Apagar Todos](#8:apagar-todos) - trata-se de apagar a lista dos pontos. A informação dos pontos fica registada nas variáveis <b>b_numpt</b> e <b>b_pontos</b>.
* [9:DiagPsi: Para Trás](#9:diagpsi:-para-tras)
* [A:Psicrometria: Sair](#a:psicrometria:-sair)
* [B:Fazer umas contas](#b:fazer-umas-contas)
...
:---: | :---:
<img src='{{ site.url }}/img215/ManualAsstermo215Psicrometria_16.png' /> | <img src='{{ site.url }}/img215/ManualAsstermo215Psicrometria_17.png' />
...
:---: | :---:
<img src='{{ site.url }}/img215/ManualAsstermo215Psicrometria_18.png' /> | <img src='{{ site.url }}/img215/ManualAsstermo215Psicrometria_19.png' />
...
|:----:
|<img src='{{ site.url }}/img215/ManualAsstermo215Psicrometria_20.png' />
...
|:---:
|<img src='{{ site.url }}/img215/ManualAsstermo215Psicrometria_21.png' />
...
:---: | :---:
<img src='{{ site.url }}/img215/ManualAsstermo215Psicrometria_22.png' />                                                | <img src='{{ site.url }}/img215/ManualAsstermo215Psicrometria_23.png' />
...
:---: | :---:
<img src='{{ site.url }}/img215/ManualAsstermo215Psicrometria_24.png' /> | <img src='{{ site.url }}/img215/ManualAsstermo215Psicrometria_25.png' />                           
...
:---: | :---:
<img src='{{ site.url }}/img215/ManualAsstermo215Psicrometria_26.png' /> | <img src='{{ site.url }}/img215/ManualAsstermo215Psicrometria_27.png' />
...
:---: | :---:
<img src='{{ site.url }}/img215/ManualAsstermo215Psicrometria_28.png' /> | <img src='{{ site.url }}/img215/ManualAsstermo215Psicrometria_29.png' />
